...
export default function InvoiceTemplate({ invoice, invoiceNo, grandTotal, feeStudent: { chargeHeads, student } }: Props) {
    return (
        <div className="min-h-[297mm] w-[210mm] bg-white p-8 text-black">
            {/* Header */}
