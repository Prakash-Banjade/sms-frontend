                                            ...
                                            <div className="flex gap-4 rounded-lg p-4 bg-secondary/20" key={leaveRequest.id}>
                                                ...
                                                <div className="flex-1 space-y-1">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <p className="text-sm text-muted-foreground">3 days (Dec 15-17)</p>
                                                    </div>
                                                    <div className="flex items-center gap-2">
                                                        <Clock className="size-4 text-muted-foreground" />
                                                        <p className="text-sm text-muted-foreground">Requested {formatDistanceToNow(new Date(leaveRequest.createdAt))} ago</p>
                                                    </div>
                                                </div>
                                        ...
                                        leaveRequests?.teachersLeaveRequests?.data?.map(leaveRequest => (
                                            <div className="flex gap-4 rounded-lg p-4 bg-secondary/20" key={leaveRequest.id}>
                                                ...
                                                <div className="flex-1 space-y-1">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        <CalendarOff className="size-4 text-muted-foreground" />
                                                        <p className="text-sm text-muted-foreground">5 days (Dec 18-22)</p>
                                                    </div>
                                                    <div className="flex items-center gap-2">
                                                        <Clock className="size-4 text-muted-foreground" />
                                                        <p className="text-sm text-muted-foreground">Requested {formatDistanceToNow(new Date(leaveRequest.createdAt))} ago</p>
