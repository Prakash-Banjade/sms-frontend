...
import FacultiesListPage from './pages/faculties/faculties-list.page';
import AddFacultyPage from './pages/faculties/add-faculty.page';
import EditFacultyPage from './pages/faculties/edit-faculty.page';
